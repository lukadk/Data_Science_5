...
# Step 4: Call the Mistral model from Ollama
def extract_information_with_llm(text):
    ...
    print("LLM Output:", result.stdout)  # Debugging line to check LLM output
...
def process_folder(folder_path):
    ...
    for filename in os.listdir(folder_path):
        if filename.endswith('.pdf'):
            ...
            llm_output = extract_information_with_llm(cleaned_text)
...
if __name__ == "__main__":
    input_folder = os.path.join("Projects", "DS5", "uploads")  # Modified path
